...
SizedBox(height: 16),
Text(
'4Editor - создан для улучшения Ваших фото, следите за тем, что сегодня предлагает ИИ и редактируйте свои фото. Спросите у чат-бота о том, что необходимо для реализации крутых фото!',
style: TextStyle(
fontSize: 24,
